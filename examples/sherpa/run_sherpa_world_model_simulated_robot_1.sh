...
# Example configuration for a wasp. Note that all variables have default values,
...
export SWM_REMOTE_OUT_PORT=11511  # default value = 11511
...
export SWM_REMOTE_IP_SECONDARY=127.0.0.1 # default value = 127.0.0.1
export SWM_REMOTE_OUT_PORT_SECONDARY=11611 # default value = 11611
